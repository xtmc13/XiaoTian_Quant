...
func registerStrategyFactories() {
	...
	strategy.RegisterStrategyFactory("trend_long", func() strategy.Strategy { return strategies.NewEMACrossStrategy() })
	strategy.RegisterStrategyFactory("trend_short", func() strategy.Strategy { return strategies.NewEMACrossStrategy() })
